...
fertilizer_dic = {
    'NHigh': """The N value of your soil is high.
    <br/> Please consider the following suggestions:
    <br/><br/> 1. <i>Add sawdust or fine woodchips to your soil</i> – the carbon in the sawdust/woodchips love nitrogen and will help absorb and soak up and excess nitrogen.
    ...
    <br/>5. <i>Do nothing</i> – It may seem counter-intuitive, but if you already have plants that are producing lots of foliage, it may be best to let them continue to absorb all the nitrogen to amend the soil for your next crops.
    
    <br/>6. <i>Avoid "green" compost</i> – Do not add fresh compost materials like grass clippings or kitchen scraps, as they are high in nitrogen and will worsen the problem.
    
    <br/>7. <i>Temporarily stop planting legumes</i> – Avoid planting nitrogen-fixing crops like beans, peas, or clover in this area until the nitrogen level is reduced.""",

    'Nlow': """The N value of soil is low.
    <br/> Please consider the following suggestions:

    <br/><br/> 1. <i> Manure </i> – adding manure is one of the simplest ways to amend your soil with nitrogen. Be careful as there are various types of manures with varying degrees of nitrogen.

    <br/> 2. <i>Coffee grinds </i> – use your morning addiction to feed your gardening habit! Coffee grinds are considered a green compost material which is rich in nitrogen.
    ...
    <br/>6. Add composted manure to the soil.
    
    <br/>7. Plant Nitrogen fixing plants like peas or beans.
    
    <br/>8. <i>Use NPK fertilizers with high N value.</i>
    
    <br/>9. <i>Add organic meals</i> – Use amendments like blood meal, cottonseed meal, or feather meal, which are all potent organic sources of nitrogen.""",
    ...
    <br/>6. <i>Avoid bone meal and rock phosphate</i> – These are common organic amendments used specifically to add phosphorus, so they should be avoided.
    
    <br/>7. <i>Add zinc</i> – High phosphorus levels can interfere with a plant's ability to absorb zinc. Consider a soil test for zinc deficiency and supplement if necessary.""",
    ...
    <br/>10. <i>Mycorrhizal Fungi</i> – Consider adding an inoculant of mycorrhizal fungi to your soil. These fungi form a symbiotic relationship with roots, helping them draw in phosphorus from the soil.""",
    ...
    <br/>3. Stop applying potassium-rich commercial fertilizer. Apply only commercial fertilizer that has a '0' in the final number field. Commercial fertilizers use a three number system for measuring levels of nitrogen, phosphorous and potassium. The last number stands for potassium.
    ...
    <br/>7. <i>Watch for nutrient lockout</i> – High potassium can block the plant's ability to absorb Magnesium (Mg) and Calcium (Ca). You may see signs of magnesium deficiency (yellowing leaves with green veins). Consider supplementing with Epsom salts (for Mg) if this occurs.""",
    ...
    <br/><br/>1. Mix in muricate of potash or sulphate of potash
    <br/>2. Try kelp meal or seaweed
    <br/>3. Try Sul-Po-Mag (Sulfate of Potash-Magnesia)
    <br/>4. Bury banana peels an inch below the soils surface
    <br/>5. Use Potash fertilizers since they contain high values potassium
    <br/>6. <i>Add Wood Ash</i> – Wood ash from a fireplace is an excellent, fast-acting source of potassium (and calcium). Be careful, as it will also raise your soil's pH.
    <br/>7. <i>Use Greensand</i> – This is a naturally occurring mineral (glauconite) that is a great slow-release source of potassium and also helps improve soil structure.
    """
}